...
export const metadata: Metadata = {
  ...
  description:
    "Công cụ tính lương net từ gross: BHXH 8%, BHYT 1.5%, BHTN 1%, giảm trừ gia cảnh và thuế TNCN lũy tiến theo tháng.",
};
    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm leading-relaxed text-ink-muted">
          ...
          người lao động (10,5%), giảm trừ và thuế TNCN lũy tiến theo tháng.
        </p>
      </header>
